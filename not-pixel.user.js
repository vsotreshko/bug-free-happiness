// ==UserScript==
// @name         Not Pixel Autoclicker Fix
// @namespace    Violentmonkey Scripts
// @match        *://*notpx.app/*
// @version      1.0
// @grant        none
// @icon         https://notpx.app/favicon.ico
// @downloadURL  https://github.com/vsotreshko/bug-free-happiness/raw/main/not-pixel.user.js
// @updateURL    https://github.com/vsotreshko/bug-free-happiness/raw/main/not-pixel.user.js
// ==/UserScript==
  ...
  if (paintButton) {
    ...
    if (buttonText === "Paint") {
      waitForElement("#canvasHolder", (canvas) => {
        ...
        const nextClickDelay = Math.floor(Math.random() * 4000) + 1000;
