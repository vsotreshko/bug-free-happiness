...
// @downloadURL  https://github.com/vsotreshko/bug-free-happiness/raw/main/bybit.user.js
// @updateURL    https://github.com/vsotreshko/bug-free-happiness/raw/main/bybit.user.js
// ==/UserScript==
        ...
        for (let col = 0; col < cols; col++) {
          ...
          if (cell["type"] === "number") {
            ...
            let closedNeighbors = neighbors.filter(
              (n) => field[n[0]][n[1]]["type"] === "closed" && !field[n[0]][n[1]].hasOwnProperty("flagged")
            );
            let flaggedNeighbors = neighbors.filter((n) => field[n[0]][n[1]].hasOwnProperty("flagged"));
    ...
    for (let n of neighbors) {
      ...
      if (n_cell["type"] === "number") {
        ...
        let closedNeighbors = get_neighbors(field, n_row, n_col).filter(
          (nb) => field[nb[0]][nb[1]]["type"] === "closed" && !field[nb[0]][nb[1]].hasOwnProperty("flagged")
        );
