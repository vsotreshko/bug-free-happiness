...
const GAME_SETTINGS = {
  ...
  autoClaimMinDelay: 60000, // 2 минуты
...
settingsMenu.appendChild(
  createSettingElement(
    ...
    300000,
    1000,
    "EN: Minimum pause duration when energy is low.<br>" + "RU: Минимальная длительность паузы при низкой энергии."
  )
);
settingsMenu.appendChild(
  createSettingElement(
    "Max pause duration (ms)",
    "maxPauseDuration",
    "range",
    10000,
    900000,
    1000,
    "EN: Maximum pause duration when energy is low.<br>" + "RU: Максимальная длительность паузы при низкой энергии."
  )
);
settingsMenu.appendChild(
...
settingsMenu.appendChild(
  createCheckboxSetting(
    "Enable Auto Change Color",
    "autoChangeColorEnabled",
